...
namespace ATL
{
    ...
    public class Track
    {
        ...
        private ICollection<string> initialAdditionalFields  = new List<string>(); // Initial fields, used to identify removed ones
        ...
        private AudioFileIO fileIO; // = new AudioFileIO();
