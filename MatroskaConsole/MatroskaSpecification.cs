...
namespace Matroska
{
    ...
    public static class MatroskaSpecification
    {
        ...
        private static readonly Dictionary<NEbml.Core.VInt, ElementDescriptor> _elementDescriptors = new Dictionary<NEbml.Core.VInt, ElementDescriptor>();

        /// <summary>
        /// Gets a dictionary of all Matroska elements.
        /// </summary>
        public static IReadOnlyDictionary<NEbml.Core.VInt, ElementDescriptor> ElementDescriptors => _elementDescriptors;
