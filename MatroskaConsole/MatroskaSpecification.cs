...
namespace Matroska
{
    ...
    public static class MatroskaSpecification
    {
        ...
        public static readonly ElementDescriptor EBMLDescriptor = new ElementDescriptor((long)EBML, "EBMLDescriptor", ElementType.MasterElement);

        /// <summary>The version of EBML parser used to create the file.</summary>
        public const ulong EBMLVersion = 0x00004286;
        public static readonly ElementDescriptor EBMLVersionDescriptor = new ElementDescriptor((long)EBMLVersion, "EBMLVersionDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor EBMLReadVersionDescriptor = new ElementDescriptor((long)EBMLReadVersion, "EBMLReadVersionDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor EBMLMaxIDLengthDescriptor = new ElementDescriptor((long)EBMLMaxIDLength, "EBMLMaxIDLengthDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor EBMLMaxSizeLengthDescriptor = new ElementDescriptor((long)EBMLMaxSizeLength, "EBMLMaxSizeLengthDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor DocTypeDescriptor = new ElementDescriptor((long)DocType, "DocTypeDescriptor", ElementType.AsciiString);

        /// <summary>The version of DocType interpreter used to create the file.</summary>
        public const ulong DocTypeVersion = 0x00004287;
        public static readonly ElementDescriptor DocTypeVersionDescriptor = new ElementDescriptor((long)DocTypeVersion, "DocTypeVersionDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor DocTypeReadVersionDescriptor = new ElementDescriptor((long)DocTypeReadVersion, "DocTypeReadVersionDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor VoidDescriptor = new ElementDescriptor((long)Void, "VoidDescriptor", ElementType.Binary);
        ...
        public static readonly ElementDescriptor SignatureSlotDescriptor = new ElementDescriptor((long)SignatureSlot, "SignatureSlotDescriptor", ElementType.MasterElement);

        /// <summary>Signature algorithm used (1=RSA, 2=elliptic).</summary>
        public const ulong SignatureAlgo = 0x00007E8A;
        public static readonly ElementDescriptor SignatureAlgoDescriptor = new ElementDescriptor((long)SignatureAlgo, "SignatureAlgoDescriptor", ElementType.UnsignedInteger);

        /// <summary>Hash algorithm used (1=SHA1-160, 2=MD5).</summary>
        public const ulong SignatureHash = 0x00007E9A;
        public static readonly ElementDescriptor SignatureHashDescriptor = new ElementDescriptor((long)SignatureHash, "SignatureHashDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor SignaturePublicKeyDescriptor = new ElementDescriptor((long)SignaturePublicKey, "SignaturePublicKeyDescriptor", ElementType.Binary);

        /// <summary>The signature of the data (until a new.</summary>
        public const ulong Signature = 0x00007EB5;
        public static readonly ElementDescriptor SignatureDescriptor = new ElementDescriptor((long)Signature, "SignatureDescriptor", ElementType.Binary);
        ...
        public static readonly ElementDescriptor SignatureElementsDescriptor = new ElementDescriptor((long)SignatureElements, "SignatureElementsDescriptor", ElementType.MasterElement);
        ...
        public static readonly ElementDescriptor SignatureElementListDescriptor = new ElementDescriptor((long)SignatureElementList, "SignatureElementListDescriptor", ElementType.MasterElement);
        ...
        public static readonly ElementDescriptor SignedElementDescriptor = new ElementDescriptor((long)SignedElement, "SignedElementDescriptor", ElementType.Binary);
        ...
        public static readonly ElementDescriptor SegmentDescriptor = new ElementDescriptor((long)Segment, "SegmentDescriptor", ElementType.MasterElement);

        /// <summary>Contains the position of other Top-Level Elements.</summary>
        public const ulong SeekHead = 0x114D9B74;
        public static readonly ElementDescriptor SeekHeadDescriptor = new ElementDescriptor((long)SeekHead, "SeekHeadDescriptor", ElementType.MasterElement);

        /// <summary>Contains a single seek entry to an EBML Element.</summary>
        public const ulong Seek = 0x00004DBB;
        public static readonly ElementDescriptor SeekDescriptor = new ElementDescriptor((long)Seek, "SeekDescriptor", ElementType.MasterElement);

        /// <summary>The binary ID corresponding to the Element name.</summary>
        public const ulong SeekID = 0x000053AB;
        public static readonly ElementDescriptor SeekIDDescriptor = new ElementDescriptor((long)SeekID, "SeekIDDescriptor", ElementType.Binary);
        ...
        public static readonly ElementDescriptor SeekPositionDescriptor = new ElementDescriptor((long)SeekPosition, "SeekPositionDescriptor", ElementType.UnsignedInteger);

        /// <summary>Contains miscellaneous general information and statistics on the file.</summary>
        public const ulong Info = 0x1549A966;
        public static readonly ElementDescriptor InfoDescriptor = new ElementDescriptor((long)Info, "InfoDescriptor", ElementType.MasterElement);
        ...
        public static readonly ElementDescriptor SegmentUIDDescriptor = new ElementDescriptor((long)SegmentUID, "SegmentUIDDescriptor", ElementType.Binary);

        /// <summary>A filename corresponding to this Segment.</summary>
        public const ulong SegmentFilename = 0x00007384;
        public static readonly ElementDescriptor SegmentFilenameDescriptor = new ElementDescriptor((long)SegmentFilename, "SegmentFilenameDescriptor", ElementType.Utf8String);

        /// <summary>A unique ID to identify the previous chained Segment (128 bits).</summary>
        public const ulong PrevUID = 0x003CB923;
        public static readonly ElementDescriptor PrevUIDDescriptor = new ElementDescriptor((long)PrevUID, "PrevUIDDescriptor", ElementType.Binary);

        /// <summary>An escaped filename corresponding to the previous Segment.</summary>
        public const ulong PrevFilename = 0x003C83AB;
        public static readonly ElementDescriptor PrevFilenameDescriptor = new ElementDescriptor((long)PrevFilename, "PrevFilenameDescriptor", ElementType.Utf8String);

        /// <summary>A unique ID to identify the next chained Segment (128 bits).</summary>
        public const ulong NextUID = 0x003EB923;
        public static readonly ElementDescriptor NextUIDDescriptor = new ElementDescriptor((long)NextUID, "NextUIDDescriptor", ElementType.Binary);

        /// <summary>An escaped filename corresponding to the next Segment.</summary>
        public const ulong NextFilename = 0x003E83BB;
        public static readonly ElementDescriptor NextFilenameDescriptor = new ElementDescriptor((long)NextFilename, "NextFilenameDescriptor", ElementType.Utf8String);
        ...
        public static readonly ElementDescriptor SegmentFamilyDescriptor = new ElementDescriptor((long)SegmentFamily, "SegmentFamilyDescriptor", ElementType.Binary);
        ...
        public static readonly ElementDescriptor ChapterTranslateDescriptor = new ElementDescriptor((long)ChapterTranslate, "ChapterTranslateDescriptor", ElementType.MasterElement);
        ...
        public static readonly ElementDescriptor ChapterTranslateEditionUIDDescriptor = new ElementDescriptor((long)ChapterTranslateEditionUID, "ChapterTranslateEditionUIDDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor ChapterTranslateCodecDescriptor = new ElementDescriptor((long)ChapterTranslateCodec, "ChapterTranslateCodecDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor ChapterTranslateIDDescriptor = new ElementDescriptor((long)ChapterTranslateID, "ChapterTranslateIDDescriptor", ElementType.Binary);
        ...
        public const ulong TimecodeScale = 0x002AD7B1;
        public static readonly ElementDescriptor TimecodeScaleDescriptor = new ElementDescriptor((long)TimecodeScale, "TimecodeScaleDescriptor", ElementType.UnsignedInteger);

        /// <summary>Duration of the Segment (based on TimecodeScale).</summary>
        public const ulong Duration = 0x00004489;
        public static readonly ElementDescriptor DurationDescriptor = new ElementDescriptor((long)Duration, "DurationDescriptor", ElementType.Float);

        /// <summary>Date of the origin of timestamp (value 0), i.e. production date.</summary>
        public const ulong DateUTC = 0x00004461;
        public static readonly ElementDescriptor DateUTCDescriptor = new ElementDescriptor((long)DateUTC, "DateUTCDescriptor", ElementType.Date);

        /// <summary>General name of the Segment.</summary>
        public const ulong Title = 0x00007BA9;
        public static readonly ElementDescriptor TitleDescriptor = new ElementDescriptor((long)Title, "TitleDescriptor", ElementType.Utf8String);

        /// <summary>Muxing application or library ("libmatroska-0.4.3").</summary>
        public const ulong MuxingApp = 0x00004D80;
        public static readonly ElementDescriptor MuxingAppDescriptor = new ElementDescriptor((long)MuxingApp, "MuxingAppDescriptor", ElementType.Utf8String);

        /// <summary>Writing application ("mkvmerge-0.3.3").</summary>
        public const ulong WritingApp = 0x00005741;
        public static readonly ElementDescriptor WritingAppDescriptor = new ElementDescriptor((long)WritingApp, "WritingAppDescriptor", ElementType.Utf8String);

        /// <summary>The Top-Level Element containing the (monolithic) Block structure.</summary>
        public const ulong Cluster = 0x1F43B675;
        public static readonly ElementDescriptor ClusterDescriptor = new ElementDescriptor((long)Cluster, "ClusterDescriptor", ElementType.MasterElement);

        /// <summary>Absolute timestamp of the cluster (based on TimecodeScale).</summary>
        public const ulong Timecode = 0x000000E7;
        public static readonly ElementDescriptor TimecodeDescriptor = new ElementDescriptor((long)Timecode, "TimecodeDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor SilentTracksDescriptor = new ElementDescriptor((long)SilentTracks, "SilentTracksDescriptor", ElementType.MasterElement);
        ...
        public static readonly ElementDescriptor SilentTrackNumberDescriptor = new ElementDescriptor((long)SilentTrackNumber, "SilentTrackNumberDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor PositionDescriptor = new ElementDescriptor((long)Position, "PositionDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor PrevSizeDescriptor = new ElementDescriptor((long)PrevSize, "PrevSizeDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor SimpleBlockDescriptor = new ElementDescriptor((long)SimpleBlock, "SimpleBlockDescriptor", ElementType.Binary);
        ...
        public static readonly ElementDescriptor BlockGroupDescriptor = new ElementDescriptor((long)BlockGroup, "BlockGroupDescriptor", ElementType.MasterElement);
        ...
        public static readonly ElementDescriptor BlockDescriptor = new ElementDescriptor((long)Block, "BlockDescriptor", ElementType.Binary);
        ...
        public static readonly ElementDescriptor BlockVirtualDescriptor = new ElementDescriptor((long)BlockVirtual, "BlockVirtualDescriptor", ElementType.Binary);
        ...
        public static readonly ElementDescriptor BlockAdditionsDescriptor = new ElementDescriptor((long)BlockAdditions, "BlockAdditionsDescriptor", ElementType.MasterElement);

        /// <summary>Contain the BlockAdditional and some parameters.</summary>
        public const ulong BlockMore = 0x000000A6;
        public static readonly ElementDescriptor BlockMoreDescriptor = new ElementDescriptor((long)BlockMore, "BlockMoreDescriptor", ElementType.MasterElement);

        /// <summary>An ID to identify the BlockAdditional level.</summary>
        public const ulong BlockAddID = 0x000000EE;
        public static readonly ElementDescriptor BlockAddIDDescriptor = new ElementDescriptor((long)BlockAddID, "BlockAddIDDescriptor", ElementType.UnsignedInteger);

        /// <summary>Interpreted by the codec as it wishes (using the BlockAddID).</summary>
        public const ulong BlockAdditional = 0x000000A5;
        public static readonly ElementDescriptor BlockAdditionalDescriptor = new ElementDescriptor((long)BlockAdditional, "BlockAdditionalDescriptor", ElementType.Binary);
        ...
        public static readonly ElementDescriptor BlockDurationDescriptor = new ElementDescriptor((long)BlockDuration, "BlockDurationDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor ReferencePriorityDescriptor = new ElementDescriptor((long)ReferencePriority, "ReferencePriorityDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor ReferenceBlockDescriptor = new ElementDescriptor((long)ReferenceBlock, "ReferenceBlockDescriptor", ElementType.SignedInteger);
        ...
        public static readonly ElementDescriptor ReferenceVirtualDescriptor = new ElementDescriptor((long)ReferenceVirtual, "ReferenceVirtualDescriptor", ElementType.SignedInteger);
        ...
        public static readonly ElementDescriptor CodecStateDescriptor = new ElementDescriptor((long)CodecState, "CodecStateDescriptor", ElementType.Binary);
        ...
        public static readonly ElementDescriptor DiscardPaddingDescriptor = new ElementDescriptor((long)DiscardPadding, "DiscardPaddingDescriptor", ElementType.SignedInteger);

        /// <summary>Contains slices description.</summary>
        public const ulong Slices = 0x0000008E;
        public static readonly ElementDescriptor SlicesDescriptor = new ElementDescriptor((long)Slices, "SlicesDescriptor", ElementType.MasterElement);
        ...
        public static readonly ElementDescriptor TimeSliceDescriptor = new ElementDescriptor((long)TimeSlice, "TimeSliceDescriptor", ElementType.MasterElement);
        ...
        public static readonly ElementDescriptor LaceNumberDescriptor = new ElementDescriptor((long)LaceNumber, "LaceNumberDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor FrameNumberDescriptor = new ElementDescriptor((long)FrameNumber, "FrameNumberDescriptor", ElementType.UnsignedInteger);

        /// <summary>The ID of the BlockAdditional Element (0 is the main Block).</summary>
        public const ulong BlockAdditionID = 0x000000CB;
        public static readonly ElementDescriptor BlockAdditionIDDescriptor = new ElementDescriptor((long)BlockAdditionID, "BlockAdditionIDDescriptor", ElementType.UnsignedInteger);

        /// <summary>The (scaled) delay to apply to the Element.</summary>
        public const ulong Delay = 0x000000CE;
        public static readonly ElementDescriptor DelayDescriptor = new ElementDescriptor((long)Delay, "DelayDescriptor", ElementType.UnsignedInteger);

        /// <summary>The (scaled) duration to apply to the Element.</summary>
        public const ulong SliceDuration = 0x000000CF;
        public static readonly ElementDescriptor SliceDurationDescriptor = new ElementDescriptor((long)SliceDuration, "SliceDurationDescriptor", ElementType.UnsignedInteger);

        /// <summary>DivX trick track extenstions</summary>
        public const ulong ReferenceFrame = 0x000000C8;
        public static readonly ElementDescriptor ReferenceFrameDescriptor = new ElementDescriptor((long)ReferenceFrame, "ReferenceFrameDescriptor", ElementType.MasterElement);

        /// <summary>DivX trick track extenstions</summary>
        public const ulong ReferenceOffset = 0x000000C9;
        public static readonly ElementDescriptor ReferenceOffsetDescriptor = new ElementDescriptor((long)ReferenceOffset, "ReferenceOffsetDescriptor", ElementType.UnsignedInteger);

        /// <summary>DivX trick track extenstions</summary>
        public const ulong ReferenceTimeCode = 0x000000CA;
        public static readonly ElementDescriptor ReferenceTimeCodeDescriptor = new ElementDescriptor((long)ReferenceTimeCode, "ReferenceTimeCodeDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor EncryptedBlockDescriptor = new ElementDescriptor((long)EncryptedBlock, "EncryptedBlockDescriptor", ElementType.Binary);

        /// <summary>A Top-Level Element of information with many tracks described.</summary>
        public const ulong Tracks = 0x1654AE6B;
        public static readonly ElementDescriptor TracksDescriptor = new ElementDescriptor((long)Tracks, "TracksDescriptor", ElementType.MasterElement);

        /// <summary>Describes a track with all Elements.</summary>
        public const ulong TrackEntry = 0x000000AE;
        public static readonly ElementDescriptor TrackEntryDescriptor = new ElementDescriptor((long)TrackEntry, "TrackEntryDescriptor", ElementType.MasterElement);
        ...
        public static readonly ElementDescriptor TrackNumberDescriptor = new ElementDescriptor((long)TrackNumber, "TrackNumberDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor TrackUIDDescriptor = new ElementDescriptor((long)TrackUID, "TrackUIDDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor TrackTypeDescriptor = new ElementDescriptor((long)TrackType, "TrackTypeDescriptor", ElementType.UnsignedInteger);

        /// <summary>Set if the track is usable. (1 bit)</summary>
        public const ulong FlagEnabled = 0x000000B9;
        public static readonly ElementDescriptor FlagEnabledDescriptor = new ElementDescriptor((long)FlagEnabled, "FlagEnabledDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor FlagDefaultDescriptor = new ElementDescriptor((long)FlagDefault, "FlagDefaultDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor FlagForcedDescriptor = new ElementDescriptor((long)FlagForced, "FlagForcedDescriptor", ElementType.UnsignedInteger);

        /// <summary>Set if the track may contain blocks using lacing. (1 bit)</summary>
        public const ulong FlagLacing = 0x0000009C;
        public static readonly ElementDescriptor FlagLacingDescriptor = new ElementDescriptor((long)FlagLacing, "FlagLacingDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor MinCacheDescriptor = new ElementDescriptor((long)MinCache, "MinCacheDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor MaxCacheDescriptor = new ElementDescriptor((long)MaxCache, "MaxCacheDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor DefaultDurationDescriptor = new ElementDescriptor((long)DefaultDuration, "DefaultDurationDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor DefaultDecodedFieldDurationDescriptor = new ElementDescriptor((long)DefaultDecodedFieldDuration, "DefaultDecodedFieldDurationDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor TrackTimecodeScaleDescriptor = new ElementDescriptor((long)TrackTimecodeScale, "TrackTimecodeScaleDescriptor", ElementType.Float);
        ...
        public static readonly ElementDescriptor TrackOffsetDescriptor = new ElementDescriptor((long)TrackOffset, "TrackOffsetDescriptor", ElementType.SignedInteger);
        ...
        public static readonly ElementDescriptor MaxBlockAdditionIDDescriptor = new ElementDescriptor((long)MaxBlockAdditionID, "MaxBlockAdditionIDDescriptor", ElementType.UnsignedInteger);

        /// <summary>A human-readable track name.</summary>
        public const ulong Name = 0x0000536E;
        public static readonly ElementDescriptor NameDescriptor = new ElementDescriptor((long)Name, "NameDescriptor", ElementType.Utf8String);

        /// <summary>Specifies the language of the track in the Matroska languages form.</summary>
        public const ulong Language = 0x0022B59C;
        public static readonly ElementDescriptor LanguageDescriptor = new ElementDescriptor((long)Language, "LanguageDescriptor", ElementType.AsciiString);

        /// <summary>An ID corresponding to the codec, see the codec page for more info.</summary>
        public const ulong CodecID = 0x00000086;
        public static readonly ElementDescriptor CodecIDDescriptor = new ElementDescriptor((long)CodecID, "CodecIDDescriptor", ElementType.AsciiString);

        /// <summary>Private data only known to the codec.</summary>
        public const ulong CodecPrivate = 0x000063A2;
        public static readonly ElementDescriptor CodecPrivateDescriptor = new ElementDescriptor((long)CodecPrivate, "CodecPrivateDescriptor", ElementType.Binary);

        /// <summary>A human-readable string specifying the codec.</summary>
        public const ulong CodecName = 0x00258688;
        public static readonly ElementDescriptor CodecNameDescriptor = new ElementDescriptor((long)CodecName, "CodecNameDescriptor", ElementType.Utf8String);

        /// <summary>The UID of an attachment that is used by this codec.</summary>
        public const ulong AttachmentLink = 0x00007446;
        public static readonly ElementDescriptor AttachmentLinkDescriptor = new ElementDescriptor((long)AttachmentLink, "AttachmentLinkDescriptor", ElementType.UnsignedInteger);

        /// <summary>A string describing the encoding setting used.</summary>
        public const ulong CodecSettings = 0x003A9697;
        public static readonly ElementDescriptor CodecSettingsDescriptor = new ElementDescriptor((long)CodecSettings, "CodecSettingsDescriptor", ElementType.Utf8String);

        /// <summary>A URL to find information about the codec used.</summary>
        public const ulong CodecInfoURL = 0x003B4040;
        public static readonly ElementDescriptor CodecInfoURLDescriptor = new ElementDescriptor((long)CodecInfoURL, "CodecInfoURLDescriptor", ElementType.AsciiString);

        /// <summary>A URL to download about the codec used.</summary>
        public const ulong CodecDownloadURL = 0x0026B240;
        public static readonly ElementDescriptor CodecDownloadURLDescriptor = new ElementDescriptor((long)CodecDownloadURL, "CodecDownloadURLDescriptor", ElementType.AsciiString);

        /// <summary>The codec can decode potentially damaged data (1 bit).</summary>
        public const ulong CodecDecodeAll = 0x000000AA;
        public static readonly ElementDescriptor CodecDecodeAllDescriptor = new ElementDescriptor((long)CodecDecodeAll, "CodecDecodeAllDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor TrackOverlayDescriptor = new ElementDescriptor((long)TrackOverlay, "TrackOverlayDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor CodecDelayDescriptor = new ElementDescriptor((long)CodecDelay, "CodecDelayDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor SeekPreRollDescriptor = new ElementDescriptor((long)SeekPreRoll, "SeekPreRollDescriptor", ElementType.UnsignedInteger);

        /// <summary>The track identification for the given Chapter Codec.</summary>
        public const ulong TrackTranslate = 0x00006624;
        public static readonly ElementDescriptor TrackTranslateDescriptor = new ElementDescriptor((long)TrackTranslate, "TrackTranslateDescriptor", ElementType.MasterElement);
        ...
        public static readonly ElementDescriptor TrackTranslateEditionUIDDescriptor = new ElementDescriptor((long)TrackTranslateEditionUID, "TrackTranslateEditionUIDDescriptor", ElementType.UnsignedInteger);

        /// <summary>The chapter codec using this ID (0: Matroska Script, 1: DVD-menu).</summary>
        public const ulong TrackTranslateCodec = 0x000066BF;
        public static readonly ElementDescriptor TrackTranslateCodecDescriptor = new ElementDescriptor((long)TrackTranslateCodec, "TrackTranslateCodecDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor TrackTranslateTrackIDDescriptor = new ElementDescriptor((long)TrackTranslateTrackID, "TrackTranslateTrackIDDescriptor", ElementType.Binary);

        /// <summary>Video settings.</summary>
        public const ulong Video = 0x000000E0;
        public static readonly ElementDescriptor VideoDescriptor = new ElementDescriptor((long)Video, "VideoDescriptor", ElementType.MasterElement);
        ...
        public static readonly ElementDescriptor FlagInterlacedDescriptor = new ElementDescriptor((long)FlagInterlaced, "FlagInterlacedDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor FieldOrderDescriptor = new ElementDescriptor((long)FieldOrder, "FieldOrderDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor StereoModeDescriptor = new ElementDescriptor((long)StereoMode, "StereoModeDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor AlphaModeDescriptor = new ElementDescriptor((long)AlphaMode, "AlphaModeDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor OldStereoModeDescriptor = new ElementDescriptor((long)OldStereoMode, "OldStereoModeDescriptor", ElementType.UnsignedInteger);

        /// <summary>Width of the encoded video frames in pixels.</summary>
        public const ulong PixelWidth = 0x000000B0;
        public static readonly ElementDescriptor PixelWidthDescriptor = new ElementDescriptor((long)PixelWidth, "PixelWidthDescriptor", ElementType.UnsignedInteger);

        /// <summary>Height of the encoded video frames in pixels.</summary>
        public const ulong PixelHeight = 0x000000BA;
        public static readonly ElementDescriptor PixelHeightDescriptor = new ElementDescriptor((long)PixelHeight, "PixelHeightDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor PixelCropBottomDescriptor = new ElementDescriptor((long)PixelCropBottom, "PixelCropBottomDescriptor", ElementType.UnsignedInteger);

        /// <summary>The number of video pixels to remove at the top of the image.</summary>
        public const ulong PixelCropTop = 0x000054BB;
        public static readonly ElementDescriptor PixelCropTopDescriptor = new ElementDescriptor((long)PixelCropTop, "PixelCropTopDescriptor", ElementType.UnsignedInteger);

        /// <summary>The number of video pixels to remove on the left of the image.</summary>
        public const ulong PixelCropLeft = 0x000054CC;
        public static readonly ElementDescriptor PixelCropLeftDescriptor = new ElementDescriptor((long)PixelCropLeft, "PixelCropLeftDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor PixelCropRightDescriptor = new ElementDescriptor((long)PixelCropRight, "PixelCropRightDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor DisplayWidthDescriptor = new ElementDescriptor((long)DisplayWidth, "DisplayWidthDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor DisplayHeightDescriptor = new ElementDescriptor((long)DisplayHeight, "DisplayHeightDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor DisplayUnitDescriptor = new ElementDescriptor((long)DisplayUnit, "DisplayUnitDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor AspectRatioTypeDescriptor = new ElementDescriptor((long)AspectRatioType, "AspectRatioTypeDescriptor", ElementType.UnsignedInteger);

        /// <summary>Same value as in AVI (32 bits).</summary>
        public const ulong ColourSpace = 0x002EB524;
        public static readonly ElementDescriptor ColourSpaceDescriptor = new ElementDescriptor((long)ColourSpace, "ColourSpaceDescriptor", ElementType.Binary);

        /// <summary>Gamma Value.</summary>
        public const ulong GammaValue = 0x002FB523;
        public static readonly ElementDescriptor GammaValueDescriptor = new ElementDescriptor((long)GammaValue, "GammaValueDescriptor", ElementType.Float);

        /// <summary>Number of frames per second. Informational only.</summary>
        public const ulong FrameRate = 0x002383E3;
        public static readonly ElementDescriptor FrameRateDescriptor = new ElementDescriptor((long)FrameRate, "FrameRateDescriptor", ElementType.Float);

        /// <summary> Settings describing the colour format.</summary>
        public const ulong Colour = 0x000055B0;
        public static readonly ElementDescriptor ColourDescriptor = new ElementDescriptor((long)Colour, "ColourDescriptor", ElementType.MasterElement);
        ...
        public static readonly ElementDescriptor MatrixCoefficientsDescriptor = new ElementDescriptor((long)MatrixCoefficients, "MatrixCoefficientsDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor BitsPerChannelDescriptor = new ElementDescriptor((long)BitsPerChannel, "BitsPerChannelDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor ChromaSubsamplingHorzDescriptor = new ElementDescriptor((long)ChromaSubsamplingHorz, "ChromaSubsamplingHorzDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor ChromaSubsamplingVertDescriptor = new ElementDescriptor((long)ChromaSubsamplingVert, "ChromaSubsamplingVertDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor CbSubsamplingHorzDescriptor = new ElementDescriptor((long)CbSubsamplingHorz, "CbSubsamplingHorzDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor CbSubsamplingVertDescriptor = new ElementDescriptor((long)CbSubsamplingVert, "CbSubsamplingVertDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor ChromaSitingHorzDescriptor = new ElementDescriptor((long)ChromaSitingHorz, "ChromaSitingHorzDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor ChromaSitingVertDescriptor = new ElementDescriptor((long)ChromaSitingVert, "ChromaSitingVertDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor RangeDescriptor = new ElementDescriptor((long)Range, "RangeDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor TransferCharacteristicsDescriptor = new ElementDescriptor((long)TransferCharacteristics, "TransferCharacteristicsDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor PrimariesDescriptor = new ElementDescriptor((long)Primaries, "PrimariesDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor MaxCLLDescriptor = new ElementDescriptor((long)MaxCLL, "MaxCLLDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor MaxFALLDescriptor = new ElementDescriptor((long)MaxFALL, "MaxFALLDescriptor", ElementType.UnsignedInteger);

        /// <summary>SMPTE 2086 mastering data.</summary>
        public const ulong MasteringMetadata = 0x000055D0;
        public static readonly ElementDescriptor MasteringMetadataDescriptor = new ElementDescriptor((long)MasteringMetadata, "MasteringMetadataDescriptor", ElementType.MasterElement);

        /// <summary>Red X chromaticity coordinate as defined by CIE 1931.</summary>
        public const ulong PrimaryRChromaticityX = 0x000055D1;
        public static readonly ElementDescriptor PrimaryRChromaticityXDescriptor = new ElementDescriptor((long)PrimaryRChromaticityX, "PrimaryRChromaticityXDescriptor", ElementType.Float);

        /// <summary>Red Y chromaticity coordinate as defined by CIE 1931.</summary>
        public const ulong PrimaryRChromaticityY = 0x000055D2;
        public static readonly ElementDescriptor PrimaryRChromaticityYDescriptor = new ElementDescriptor((long)PrimaryRChromaticityY, "PrimaryRChromaticityYDescriptor", ElementType.Float);
        ...
        public static readonly ElementDescriptor PrimaryGChromaticityXDescriptor = new ElementDescriptor((long)PrimaryGChromaticityX, "PrimaryGChromaticityXDescriptor", ElementType.Float);
        ...
        public static readonly ElementDescriptor PrimaryGChromaticityYDescriptor = new ElementDescriptor((long)PrimaryGChromaticityY, "PrimaryGChromaticityYDescriptor", ElementType.Float);

        /// <summary>Blue X chromaticity coordinate as defined by CIE 1931.</summary>
        public const ulong PrimaryBChromaticityX = 0x000055D5;
        public static readonly ElementDescriptor PrimaryBChromaticityXDescriptor = new ElementDescriptor((long)PrimaryBChromaticityX, "PrimaryBChromaticityXDescriptor", ElementType.Float);

        /// <summary>Blue Y chromaticity coordinate as defined by CIE 1931.</summary>
        public const ulong PrimaryBChromaticityY = 0x000055D6;
        public static readonly ElementDescriptor PrimaryBChromaticityYDescriptor = new ElementDescriptor((long)PrimaryBChromaticityY, "PrimaryBChromaticityYDescriptor", ElementType.Float);
        ...
        public static readonly ElementDescriptor WhitePointChromaticityXDescriptor = new ElementDescriptor((long)WhitePointChromaticityX, "WhitePointChromaticityXDescriptor", ElementType.Float);
        ...
        public static readonly ElementDescriptor WhitePointChromaticityYDescriptor = new ElementDescriptor((long)WhitePointChromaticityY, "WhitePointChromaticityYDescriptor", ElementType.Float);
        ...
        public static readonly ElementDescriptor LuminanceMaxDescriptor = new ElementDescriptor((long)LuminanceMax, "LuminanceMaxDescriptor", ElementType.Float);
        ...
        public static readonly ElementDescriptor LuminanceMinDescriptor = new ElementDescriptor((long)LuminanceMin, "LuminanceMinDescriptor", ElementType.Float);

        /// <summary>Audio settings.</summary>
        public const ulong Audio = 0x000000E1;
        public static readonly ElementDescriptor AudioDescriptor = new ElementDescriptor((long)Audio, "AudioDescriptor", ElementType.MasterElement);

        /// <summary>Sampling frequency in Hz.</summary>
        public const ulong SamplingFrequency = 0x000000B5;
        public static readonly ElementDescriptor SamplingFrequencyDescriptor = new ElementDescriptor((long)SamplingFrequency, "SamplingFrequencyDescriptor", ElementType.Float);
        ...
        public static readonly ElementDescriptor OutputSamplingFrequencyDescriptor = new ElementDescriptor((long)OutputSamplingFrequency, "OutputSamplingFrequencyDescriptor", ElementType.Float);

        /// <summary>Numbers of channels in the track.</summary>
        public const ulong Channels = 0x0000009F;
        public static readonly ElementDescriptor ChannelsDescriptor = new ElementDescriptor((long)Channels, "ChannelsDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor ChannelPositionsDescriptor = new ElementDescriptor((long)ChannelPositions, "ChannelPositionsDescriptor", ElementType.Binary);

        /// <summary>Bits per sample, mostly used for PCM.</summary>
        public const ulong BitDepth = 0x00006264;
        public static readonly ElementDescriptor BitDepthDescriptor = new ElementDescriptor((long)BitDepth, "BitDepthDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor TrackOperationDescriptor = new ElementDescriptor((long)TrackOperation, "TrackOperationDescriptor", ElementType.MasterElement);
        ...
        public static readonly ElementDescriptor TrackCombinePlanesDescriptor = new ElementDescriptor((long)TrackCombinePlanes, "TrackCombinePlanesDescriptor", ElementType.MasterElement);
        ...
        public static readonly ElementDescriptor TrackPlaneDescriptor = new ElementDescriptor((long)TrackPlane, "TrackPlaneDescriptor", ElementType.MasterElement);

        /// <summary>The trackUID number of the track representing the plane.</summary>
        public const ulong TrackPlaneUID = 0x000000E5;
        public static readonly ElementDescriptor TrackPlaneUIDDescriptor = new ElementDescriptor((long)TrackPlaneUID, "TrackPlaneUIDDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor TrackPlaneTypeDescriptor = new ElementDescriptor((long)TrackPlaneType, "TrackPlaneTypeDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor TrackJoinBlocksDescriptor = new ElementDescriptor((long)TrackJoinBlocks, "TrackJoinBlocksDescriptor", ElementType.MasterElement);
        ...
        public static readonly ElementDescriptor TrackJoinUIDDescriptor = new ElementDescriptor((long)TrackJoinUID, "TrackJoinUIDDescriptor", ElementType.UnsignedInteger);

        /// <summary>DivX trick track extenstions</summary>
        public const ulong TrickTrackUID = 0x000000C0;
        public static readonly ElementDescriptor TrickTrackUIDDescriptor = new ElementDescriptor((long)TrickTrackUID, "TrickTrackUIDDescriptor", ElementType.UnsignedInteger);

        /// <summary>DivX trick track extenstions</summary>
        public const ulong TrickTrackSegmentUID = 0x000000C1;
        public static readonly ElementDescriptor TrickTrackSegmentUIDDescriptor = new ElementDescriptor((long)TrickTrackSegmentUID, "TrickTrackSegmentUIDDescriptor", ElementType.Binary);

        /// <summary>DivX trick track extenstions</summary>
        public const ulong TrickTrackFlag = 0x000000C6;
        public static readonly ElementDescriptor TrickTrackFlagDescriptor = new ElementDescriptor((long)TrickTrackFlag, "TrickTrackFlagDescriptor", ElementType.UnsignedInteger);

        /// <summary>DivX trick track extenstions</summary>
        public const ulong TrickMasterTrackUID = 0x000000C7;
        public static readonly ElementDescriptor TrickMasterTrackUIDDescriptor = new ElementDescriptor((long)TrickMasterTrackUID, "TrickMasterTrackUIDDescriptor", ElementType.UnsignedInteger);

        /// <summary>DivX trick track extenstions</summary>
        public const ulong TrickMasterTrackSegmentUID = 0x000000C4;
        public static readonly ElementDescriptor TrickMasterTrackSegmentUIDDescriptor = new ElementDescriptor((long)TrickMasterTrackSegmentUID, "TrickMasterTrackSegmentUIDDescriptor", ElementType.Binary);
        ...
        public static readonly ElementDescriptor ContentEncodingsDescriptor = new ElementDescriptor((long)ContentEncodings, "ContentEncodingsDescriptor", ElementType.MasterElement);
        ...
        public static readonly ElementDescriptor ContentEncodingDescriptor = new ElementDescriptor((long)ContentEncoding, "ContentEncodingDescriptor", ElementType.MasterElement);
        ...
        public static readonly ElementDescriptor ContentEncodingOrderDescriptor = new ElementDescriptor((long)ContentEncodingOrder, "ContentEncodingOrderDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor ContentEncodingScopeDescriptor = new ElementDescriptor((long)ContentEncodingScope, "ContentEncodingScopeDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor ContentEncodingTypeDescriptor = new ElementDescriptor((long)ContentEncodingType, "ContentEncodingTypeDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor ContentCompressionDescriptor = new ElementDescriptor((long)ContentCompression, "ContentCompressionDescriptor", ElementType.MasterElement);
        ...
        public static readonly ElementDescriptor ContentCompAlgoDescriptor = new ElementDescriptor((long)ContentCompAlgo, "ContentCompAlgoDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor ContentCompSettingsDescriptor = new ElementDescriptor((long)ContentCompSettings, "ContentCompSettingsDescriptor", ElementType.Binary);
        ...
        public static readonly ElementDescriptor ContentEncryptionDescriptor = new ElementDescriptor((long)ContentEncryption, "ContentEncryptionDescriptor", ElementType.MasterElement);
        ...
        public static readonly ElementDescriptor ContentEncAlgoDescriptor = new ElementDescriptor((long)ContentEncAlgo, "ContentEncAlgoDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor ContentEncKeyIDDescriptor = new ElementDescriptor((long)ContentEncKeyID, "ContentEncKeyIDDescriptor", ElementType.Binary);

        /// <summary>A cryptographic signature of the contents.</summary>
        public const ulong ContentSignature = 0x000047E3;
        public static readonly ElementDescriptor ContentSignatureDescriptor = new ElementDescriptor((long)ContentSignature, "ContentSignatureDescriptor", ElementType.Binary);

        /// <summary>This is the ID of the private key the data was signed with.</summary>
        public const ulong ContentSigKeyID = 0x000047E4;
        public static readonly ElementDescriptor ContentSigKeyIDDescriptor = new ElementDescriptor((long)ContentSigKeyID, "ContentSigKeyIDDescriptor", ElementType.Binary);
        ...
        public static readonly ElementDescriptor ContentSigAlgoDescriptor = new ElementDescriptor((long)ContentSigAlgo, "ContentSigAlgoDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor ContentSigHashAlgoDescriptor = new ElementDescriptor((long)ContentSigHashAlgo, "ContentSigHashAlgoDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor CuesDescriptor = new ElementDescriptor((long)Cues, "CuesDescriptor", ElementType.MasterElement);

        /// <summary>Contains all information relative to a seek point in the Segment.</summary>
        public const ulong CuePoint = 0x000000BB;
        public static readonly ElementDescriptor CuePointDescriptor = new ElementDescriptor((long)CuePoint, "CuePointDescriptor", ElementType.MasterElement);

        /// <summary>Absolute timestamp according to the Segment time base.</summary>
        public const ulong CueTime = 0x000000B3;
        public static readonly ElementDescriptor CueTimeDescriptor = new ElementDescriptor((long)CueTime, "CueTimeDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor CueTrackPositionsDescriptor = new ElementDescriptor((long)CueTrackPositions, "CueTrackPositionsDescriptor", ElementType.MasterElement);

        /// <summary>The track for which a position is given.</summary>
        public const ulong CueTrack = 0x000000F7;
        public static readonly ElementDescriptor CueTrackDescriptor = new ElementDescriptor((long)CueTrack, "CueTrackDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor CueClusterPositionDescriptor = new ElementDescriptor((long)CueClusterPosition, "CueClusterPositionDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor CueRelativePositionDescriptor = new ElementDescriptor((long)CueRelativePosition, "CueRelativePositionDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor CueDurationDescriptor = new ElementDescriptor((long)CueDuration, "CueDurationDescriptor", ElementType.UnsignedInteger);

        /// <summary>Number of the Block in the specified Cluster.</summary>
        public const ulong CueBlockNumber = 0x00005378;
        public static readonly ElementDescriptor CueBlockNumberDescriptor = new ElementDescriptor((long)CueBlockNumber, "CueBlockNumberDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor CueCodecStateDescriptor = new ElementDescriptor((long)CueCodecState, "CueCodecStateDescriptor", ElementType.UnsignedInteger);

        /// <summary>The Clusters containing the required referenced Blocks.</summary>
        public const ulong CueReference = 0x000000DB;
        public static readonly ElementDescriptor CueReferenceDescriptor = new ElementDescriptor((long)CueReference, "CueReferenceDescriptor", ElementType.MasterElement);

        /// <summary>Timestamp of the referenced Block.</summary>
        public const ulong CueRefTime = 0x00000096;
        public static readonly ElementDescriptor CueRefTimeDescriptor = new ElementDescriptor((long)CueRefTime, "CueRefTimeDescriptor", ElementType.UnsignedInteger);

        /// <summary>The Position of the Cluster containing the referenced Block.</summary>
        public const ulong CueRefCluster = 0x00000097;
        public static readonly ElementDescriptor CueRefClusterDescriptor = new ElementDescriptor((long)CueRefCluster, "CueRefClusterDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor CueRefNumberDescriptor = new ElementDescriptor((long)CueRefNumber, "CueRefNumberDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor CueRefCodecStateDescriptor = new ElementDescriptor((long)CueRefCodecState, "CueRefCodecStateDescriptor", ElementType.UnsignedInteger);

        /// <summary>Contain attached files.</summary>
        public const ulong Attachments = 0x1941A469;
        public static readonly ElementDescriptor AttachmentsDescriptor = new ElementDescriptor((long)Attachments, "AttachmentsDescriptor", ElementType.MasterElement);

        /// <summary>An attached file.</summary>
        public const ulong AttachedFile = 0x000061A7;
        public static readonly ElementDescriptor AttachedFileDescriptor = new ElementDescriptor((long)AttachedFile, "AttachedFileDescriptor", ElementType.MasterElement);

        /// <summary>A human-friendly name for the attached file.</summary>
        public const ulong FileDescription = 0x0000467E;
        public static readonly ElementDescriptor FileDescriptionDescriptor = new ElementDescriptor((long)FileDescription, "FileDescriptionDescriptor", ElementType.Utf8String);

        /// <summary>Filename of the attached file.</summary>
        public const ulong FileName = 0x0000466E;
        public static readonly ElementDescriptor FileNameDescriptor = new ElementDescriptor((long)FileName, "FileNameDescriptor", ElementType.Utf8String);

        /// <summary>MIME type of the file.</summary>
        public const ulong FileMimeType = 0x00004660;
        public static readonly ElementDescriptor FileMimeTypeDescriptor = new ElementDescriptor((long)FileMimeType, "FileMimeTypeDescriptor", ElementType.AsciiString);

        /// <summary>The data of the file.</summary>
        public const ulong FileData = 0x0000465C;
        public static readonly ElementDescriptor FileDataDescriptor = new ElementDescriptor((long)FileData, "FileDataDescriptor", ElementType.Binary);

        /// <summary>Unique ID representing the file, as random as possible.</summary>
        public const ulong FileUID = 0x000046AE;
        public static readonly ElementDescriptor FileUIDDescriptor = new ElementDescriptor((long)FileUID, "FileUIDDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor FileReferralDescriptor = new ElementDescriptor((long)FileReferral, "FileReferralDescriptor", ElementType.Binary);

        /// <summary>DivX font extension</summary>
        public const ulong FileUsedStartTime = 0x00004661;
        public static readonly ElementDescriptor FileUsedStartTimeDescriptor = new ElementDescriptor((long)FileUsedStartTime, "FileUsedStartTimeDescriptor", ElementType.UnsignedInteger);

        /// <summary>DivX font extension</summary>
        public const ulong FileUsedEndTime = 0x00004662;
        public static readonly ElementDescriptor FileUsedEndTimeDescriptor = new ElementDescriptor((long)FileUsedEndTime, "FileUsedEndTimeDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor ChaptersDescriptor = new ElementDescriptor((long)Chapters, "ChaptersDescriptor", ElementType.MasterElement);

        /// <summary>Contains all information about a Segment edition.</summary>
        public const ulong EditionEntry = 0x000045B9;
        public static readonly ElementDescriptor EditionEntryDescriptor = new ElementDescriptor((long)EditionEntry, "EditionEntryDescriptor", ElementType.MasterElement);
        ...
        public static readonly ElementDescriptor EditionUIDDescriptor = new ElementDescriptor((long)EditionUID, "EditionUIDDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor EditionFlagHiddenDescriptor = new ElementDescriptor((long)EditionFlagHidden, "EditionFlagHiddenDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor EditionFlagDefaultDescriptor = new ElementDescriptor((long)EditionFlagDefault, "EditionFlagDefaultDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor EditionFlagOrderedDescriptor = new ElementDescriptor((long)EditionFlagOrdered, "EditionFlagOrderedDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor ChapterAtomDescriptor = new ElementDescriptor((long)ChapterAtom, "ChapterAtomDescriptor", ElementType.MasterElement);

        /// <summary>A unique ID to identify the Chapter.</summary>
        public const ulong ChapterUID = 0x000073C4;
        public static readonly ElementDescriptor ChapterUIDDescriptor = new ElementDescriptor((long)ChapterUID, "ChapterUIDDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor ChapterStringUIDDescriptor = new ElementDescriptor((long)ChapterStringUID, "ChapterStringUIDDescriptor", ElementType.Utf8String);

        /// <summary>Timestamp of the start of Chapter (not scaled).</summary>
        public const ulong ChapterTimeStart = 0x00000091;
        public static readonly ElementDescriptor ChapterTimeStartDescriptor = new ElementDescriptor((long)ChapterTimeStart, "ChapterTimeStartDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor ChapterTimeEndDescriptor = new ElementDescriptor((long)ChapterTimeEnd, "ChapterTimeEndDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor ChapterFlagHiddenDescriptor = new ElementDescriptor((long)ChapterFlagHidden, "ChapterFlagHiddenDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor ChapterFlagEnabledDescriptor = new ElementDescriptor((long)ChapterFlagEnabled, "ChapterFlagEnabledDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor ChapterSegmentUIDDescriptor = new ElementDescriptor((long)ChapterSegmentUID, "ChapterSegmentUIDDescriptor", ElementType.Binary);
        ...
        public static readonly ElementDescriptor ChapterSegmentEditionUIDDescriptor = new ElementDescriptor((long)ChapterSegmentEditionUID, "ChapterSegmentEditionUIDDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor ChapterPhysicalEquivDescriptor = new ElementDescriptor((long)ChapterPhysicalEquiv, "ChapterPhysicalEquivDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor ChapterTrackDescriptor = new ElementDescriptor((long)ChapterTrack, "ChapterTrackDescriptor", ElementType.MasterElement);
        ...
        public static readonly ElementDescriptor ChapterTrackNumberDescriptor = new ElementDescriptor((long)ChapterTrackNumber, "ChapterTrackNumberDescriptor", ElementType.UnsignedInteger);

        /// <summary>Contains all possible strings to use for the chapter display.</summary>
        public const ulong ChapterDisplay = 0x00000080;
        public static readonly ElementDescriptor ChapterDisplayDescriptor = new ElementDescriptor((long)ChapterDisplay, "ChapterDisplayDescriptor", ElementType.MasterElement);

        /// <summary>Contains the string to use as the chapter atom.</summary>
        public const ulong ChapString = 0x00000085;
        public static readonly ElementDescriptor ChapStringDescriptor = new ElementDescriptor((long)ChapString, "ChapStringDescriptor", ElementType.Utf8String);
        ...
        public static readonly ElementDescriptor ChapLanguageDescriptor = new ElementDescriptor((long)ChapLanguage, "ChapLanguageDescriptor", ElementType.AsciiString);
        ...
        public static readonly ElementDescriptor ChapCountryDescriptor = new ElementDescriptor((long)ChapCountry, "ChapCountryDescriptor", ElementType.AsciiString);

        /// <summary>Contains all the commands associated to the Atom.</summary>
        public const ulong ChapProcess = 0x00006944;
        public static readonly ElementDescriptor ChapProcessDescriptor = new ElementDescriptor((long)ChapProcess, "ChapProcessDescriptor", ElementType.MasterElement);
        ...
        public static readonly ElementDescriptor ChapProcessCodecIDDescriptor = new ElementDescriptor((long)ChapProcessCodecID, "ChapProcessCodecIDDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor ChapProcessPrivateDescriptor = new ElementDescriptor((long)ChapProcessPrivate, "ChapProcessPrivateDescriptor", ElementType.Binary);

        /// <summary>Contains all the commands associated to the Atom.</summary>
        public const ulong ChapProcessCommand = 0x00006911;
        public static readonly ElementDescriptor ChapProcessCommandDescriptor = new ElementDescriptor((long)ChapProcessCommand, "ChapProcessCommandDescriptor", ElementType.MasterElement);
        ...
        public static readonly ElementDescriptor ChapProcessTimeDescriptor = new ElementDescriptor((long)ChapProcessTime, "ChapProcessTimeDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor ChapProcessDataDescriptor = new ElementDescriptor((long)ChapProcessData, "ChapProcessDataDescriptor", ElementType.Binary);
        ...
        public static readonly ElementDescriptor TagsDescriptor = new ElementDescriptor((long)Tags, "TagsDescriptor", ElementType.MasterElement);

        /// <summary>Element containing Elements specific to Tracks/Chapters.</summary>
        public const ulong Tag = 0x00007373;
        public static readonly ElementDescriptor TagDescriptor = new ElementDescriptor((long)Tag, "TagDescriptor", ElementType.MasterElement);
        ...
        public static readonly ElementDescriptor TargetsDescriptor = new ElementDescriptor((long)Targets, "TargetsDescriptor", ElementType.MasterElement);
        ...
        public static readonly ElementDescriptor TargetTypeValueDescriptor = new ElementDescriptor((long)TargetTypeValue, "TargetTypeValueDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor TargetTypeDescriptor = new ElementDescriptor((long)TargetType, "TargetTypeDescriptor", ElementType.AsciiString);
        ...
        public static readonly ElementDescriptor TagTrackUIDDescriptor = new ElementDescriptor((long)TagTrackUID, "TagTrackUIDDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor TagEditionUIDDescriptor = new ElementDescriptor((long)TagEditionUID, "TagEditionUIDDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor TagChapterUIDDescriptor = new ElementDescriptor((long)TagChapterUID, "TagChapterUIDDescriptor", ElementType.UnsignedInteger);
        ...
        public static readonly ElementDescriptor TagAttachmentUIDDescriptor = new ElementDescriptor((long)TagAttachmentUID, "TagAttachmentUIDDescriptor", ElementType.UnsignedInteger);

        /// <summary>Contains general information about the target.</summary>
        public const ulong SimpleTag = 0x000067C8;
        public static readonly ElementDescriptor SimpleTagDescriptor = new ElementDescriptor((long)SimpleTag, "SimpleTagDescriptor", ElementType.MasterElement);

        /// <summary>The name of the Tag that is going to be stored.</summary>
        public const ulong TagName = 0x000045A3;
        public static readonly ElementDescriptor TagNameDescriptor = new ElementDescriptor((long)TagName, "TagNameDescriptor", ElementType.Utf8String);
        ...
        public static readonly ElementDescriptor TagLanguageDescriptor = new ElementDescriptor((long)TagLanguage, "TagLanguageDescriptor", ElementType.AsciiString);
        ...
        public static readonly ElementDescriptor TagDefaultDescriptor = new ElementDescriptor((long)TagDefault, "TagDefaultDescriptor", ElementType.UnsignedInteger);

        /// <summary>The value of the Tag.</summary>
        public const ulong TagString = 0x00004487;
        public static readonly ElementDescriptor TagStringDescriptor = new ElementDescriptor((long)TagString, "TagStringDescriptor", ElementType.Utf8String);
        ...
        public static readonly ElementDescriptor TagBinaryDescriptor = new ElementDescriptor((long)TagBinary, "TagBinaryDescriptor", ElementType.Binary);
