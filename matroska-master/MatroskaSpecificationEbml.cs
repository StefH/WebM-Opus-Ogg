...
namespace Matroska
{
	...
	/// </remarks>
	public static class MatroskaSpecificationEbml
	{
		#region Helper
		...
		static MatroskaSpecificationEbml()
		{
			infos = new Dictionary<uint, EbmlElementInfo>();
			FieldInfo[] fields = typeof(MatroskaSpecificationEbml).GetFields(BindingFlags.Public | BindingFlags.Static);
